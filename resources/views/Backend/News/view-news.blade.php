              ...
              <tbody class="table-border-bottom-0">
                @forelse ($news as $item)
                    <tr>
                        ...
                        <td>
                            <img src="{{url('images/'.$item->thumbnail)}}" width="120px" height="80px" style="object-fit: cover">
                       </td>
                        <td><b>{{$item->viewer}}</b></td>
                        <td>
                        <div class="dropdown">
                            ...
                            <a class="dropdown-item" href="{{route('openUpdateNews',$item->id)}}"><i class="bx bx-edit-alt me-1"></i> Edit</a>
